...
checkTasty('helloWorld', 'Test.scala', 'Test')
...
checkTasty('classInh3', 'Test.scala', 'Test')
checkTasty('classInh4', 'Test.scala', 'Test')
checkTasty('classInh5', 'Test.scala', 'Test')
checkTasty('classInh6', 'Test.scala', 'Test')
checkTasty('classInh7', 'Test.scala', 'Test')
checkTasty('classInh8', 'Test.scala', 'Test')
checkTasty('caseClass1', 'Test.scala', 'Test')
checkTasty('newTest1', 'Test.scala', 'Test')
checkTasty('newTest2', 'Test.scala', 'Test')
checkTasty('newTest3', 'Test.scala', 'Test')
...
checkTasty('classWithSelf3', 'Test.scala', 'Test')
...
checkTasty('constrTest3', 'Test.scala', 'Test')
checkTasty('constrTest4', 'Test.scala', 'Test')
checkTasty('constrTest5', 'Test.scala', 'Test')
checkTasty('constrTest6', 'Test.scala', 'Test')
checkTasty('constrWithMultiArgs1', 'Test.scala', 'Test')
checkTasty('constrWithMultiArgs2', 'Test.scala', 'Test')